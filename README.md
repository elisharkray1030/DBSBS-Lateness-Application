...
- Run `python -m mypy app.py parser.py storage.py records.py punishments.py seed_demo_data.py serve.py` for typechecking (config in `pyproject.toml`; CI runs both pytest and mypy on push/PR).
